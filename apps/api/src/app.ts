...
app.use(cors({
    origin: env.NODE_ENV === 'production' 
        ...
        : [' http://localhost:3000', 'http://localhost:5173', 'https://quickbite-roan.vercel.app', 'http://192.168.0.176:8081','http://192.168.0.176:8082', 'http://10.249.44.234:8081','http://10.249.44.234:8082'], 
    credentials: true,
