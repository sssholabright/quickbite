...
import { PaymentListItem, PaymentSort } from '../../types/payments';
...
interface PaymentsTableProps {
    ...
    onSort: (field: keyof PaymentSort['field'], direction: 'asc' | 'desc') => void;
...
const PaymentsTable: React.FC<PaymentsTableProps> = ({
    ...
    const getStatusBadge = (status: PaymentListItem['status']) => {
        const statusConfig = {
    ...
    const handleSort = (field: keyof PaymentSort['field']) => {
        onSort(field, 'desc');
    };
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <button
                                    onClick={() => handleSort('amount' as keyof PaymentSort['field'])}
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <button
                                    onClick={() => handleSort('status' as keyof PaymentSort['field'])}
                                    className="hover:text-gray-700 flex items-center"
                                >
                                    Status
                                    <svg className="ml-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                <button
                                    onClick={() => handleSort('createdAt' as keyof PaymentSort['field'])}
                                    className="hover:text-gray-700 flex items-center"
                                >
                                    Date
                                    <svg className="ml-1 h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
